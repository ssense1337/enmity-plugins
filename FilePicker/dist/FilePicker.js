...
<\/script>`}}),u=i.createElement(a,{isInModal:!0}),y=i.createElement(I,{style:{width:0}},i.createElement(a,null));w.after(k,"default",(s,[n],m)=>{o=n.currentChannel.id,m.props.children[0].props.onPress=()=>t.postMessage("open"),m.props.children[0].props.onLongPress=()=>A("openModal",!0)?l.push(()=>u):t.postMessage("open"),m.props.children.splice(0,0,y)})},onStop(){w.unpatchAll()},getSettingsPanel({settings:o}){return i.createElement(N,{settings:o})}};F(D);
