...
<\/script>`}}),p=t.createElement(l,{isInModal:!0}),g=t.createElement(B,{style:{width:0}},t.createElement(l,null));u.after(R,"default",(r,[n],s)=>{i=n.currentChannel.id,s.props.children[0].props.onPress=()=>m.postMessage("open"),s.props.children[0].props.onLongPress=()=>W("openModal",!0)?d.push(()=>p):m.postMessage("open"),s.props.children.splice(0,0,g)})},onStop(){u.unpatchAll()},getSettingsPanel({settings:o}){return t.createElement(k,{settings:o})}};v(D);
